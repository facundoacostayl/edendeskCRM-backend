...
exports.getClientsQuantity = exports.updateClient = exports.deleteClient = exports.orderByClientBalanceDesc = exports.orderByClientBalanceAsc = exports.orderByClientNameDesc = exports.orderByClientNameAsc = exports.searchClient = exports.substractFromClientBalance = exports.addToClientBalance = exports.addClient = exports.getClient = exports.getClients = void 0;
const Client_1 = require("../entities/Client");
const Operation_1 = require("../entities/Operation");
const getClients = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const clientList = yield Client_1.Client.findBy({ userId: parseInt(id) });
